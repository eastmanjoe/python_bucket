...
#
'''
Collect Data and Control the Sixnet VersaTRAK I/O module
...
class SixnetIo:
    ...
    def set_digital_output(self, do_num, do_state):
        ...
        regs = self.master.execute(self.mb_addr,
            cst.WRITE_SINGLE_COIL, do_num - 1, 1, state)
...
if __name__ == '__main__':
    ...
    while True:
        ...
        #----------------------------------------------------------------------#
        # Simulating disconnecting the gnd wire
        # response = controller.set_multiple_digital_outputs(1, 2, ['ON', 'ON'])
        # time.sleep(0.01)

        # response = controller.set_multiple_digital_outputs(1, 2, ['OFF', 'ON'])
        # time.sleep(0.01)
        #----------------------------------------------------------------------#

        #----------------------------------------------------------------------#
        # Simulating disconnecting the vdc wire
        # response = controller.set_multiple_digital_outputs(1, 2, ['ON', 'ON'])
        # time.sleep(0.01)

        # response = controller.set_multiple_digital_outputs(1, 2, ['ON', 'OFF'])
        # time.sleep(0.01)
